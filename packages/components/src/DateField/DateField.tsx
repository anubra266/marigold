...
export const DateField = (props: DateFieldProps) => {
  ...
  const styles = useComponentStyles(
    'DateField',
    {},
    { parts: ['segment', 'placeholder', 'field'] }
  );
  return (
    <Box
      __baseCSS={{
