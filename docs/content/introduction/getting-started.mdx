...
To set up Tailwind CSS, please refer to the official [installation guide](https://tailwindcss.com/docs/installation/using-postcss). Once you have completed the installation, add the chosen theme as a preset to the Tailwind CSS config, as shown below:
